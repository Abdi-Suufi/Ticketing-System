package com.example.ticketingsystem.views.ticketsubmission;
...
@PageTitle("Ticket Submission")
@Route(value = "Ticket-Submission", layout = MainLayout.class)
@RolesAllowed("ADMIN")
public class TicketSubmissionView extends Div {
    ...
    public TicketSubmissionView() {
        addClassName("ticket-submission-view");
        setSizeFull();
        createGrid();
        add(grid);
    }
